...
Prometheus is a time-series database designed for storing and querying metrics. Unlike push-based systems, Prometheus uses a **pull model**: it scrapes metrics from target endpoints at regular intervals. This Project introduces you to:
