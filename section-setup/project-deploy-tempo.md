...
4. **Storage and Retention:**
   ...
   **What to evaluate:** Does it explain that traces older than 72 hours are deleted by the compactor? Does it mention that Tempo supports object storage like S3, GCS, and Azure Blob Storage for production? Does it explain why object storage is preferred (durability, scaProjectility, cost)?
